...
# sudo rm -f /home/ec2-user/liq_superset/docker/docker-frontend.sh - Remove commited docker-frontend.sh
...
# sudo cp /home/ec2-user/docker-frontend.sh /home/ec2-user/liq_superset/docker/ - Replace with docker-frontend.sh production version
sleep 5
